...
import io.github.yyagi.mplayer.ui.components.MiniPlayerBar
import io.github.yyagi.mplayer.ui.navigation.Destinations
import io.github.yyagi.mplayer.ui.navigation.MPlayerNavHost
import io.github.yyagi.mplayer.ui.theme.MPlayerTheme

class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        val container = (application as MPlayerApplication).container
        setContent {
            MPlayerTheme {
